<p align="center">
    ...
    <br />
    <a href="https://t.me/Korean_Drama_In_Hindi_Dubbed_4u">Report a Bug</a>
    |
    <a href="https://t.me/Korean_Drama_In_Hindi_Dubbed_4u">Request Feature</a>
  </p>
...
## Please Follow Me!❤️‍🔥
### Incase you are having trouble deploying bot you may hire developer we have reasonable rates [Click Here](https://t.me/MExAkib)
...
```py
git clone https://github.com/km-zakaria-alam-akib/FileToLinkBot
cd FileToLinkBot
...
`BIN_CHANNEL` : Create a new channel (private/public), add [@missrose_bot](https://t.me/MissRose_bot) as admin to the channel and type /id. Now copy paste the ID into this field.
...
- [AKIB](https://github.com/km-zakaria-alam-akib)
