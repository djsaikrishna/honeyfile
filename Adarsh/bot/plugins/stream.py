...
async def private_receive_handler(c: Client, m: Message):
    ...
    if Var.UPDATES_CHANNEL != "None":
        try:
            ...
            if user.status == "kicked":
                await c.send_message(
                    chat_id=m.chat.id,
                    text="You are Banned!\n\n  **Contact Developer [Akib](https://t.me/MExAkib) He Will Help You**",
            ...
            await c.send_message(
                chat_id=m.chat.id,
                text="""<i>Join Our Main Channel To Use Me 🔐</i>""",
            ...
            await c.send_message(
                chat_id=m.chat.id,
                text="**Something Went Wrong. Contact My Boss** [Akib](https://t.me/MExAkib)",
    ...
    try:
        ...
        msg_text ="""<i><u>You Link Has Been Generated !</u></i>\n\n<b>📂 File Name :</b> <i>{}</i>\n\n<b>📦 File Size :</b> <i>{}</i>\n\n<b>📥 Download :</b> <i>{}</i>\n\n<b> 🖥 Watch  :</b> <i>{}</i>\n\n<b>🚸 Note : LINK WON'T EXPIRE TILL I DELETE</b>"""
